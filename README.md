...
└── examples/
    ...
    └── 案例-竞品调研助手.md     ← 端到端走查：看套件怎么用
```

## 看一个完整案例

`examples/案例-竞品调研助手.md` 用一个真实项目——「竞品调研助手」——从一句话想法走到能用，展示 4 个 Skill 怎么配合：阶段零怎么收窄范围、6 维度照出什么、五步法砍掉了哪些方案、哪些功能被"以后再说"挡掉、红线自检怎么判断"能不能自己干"。建议先读它，再上手自己的项目。
